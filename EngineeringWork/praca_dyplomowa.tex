...
\begin{figure}[!htbp]
	\centering
	\subfigure[HR]{\includegraphics[width=0.25\textwidth]{\ImgPath/rys/testy/shum/601crop.png}}
	\subfigure[LR]{\includegraphics[width=0.25\textwidth]{\ImgPath/rys/testy/shum/601x2crop.png}} 
	\subfigure[EDSR]{\includegraphics[width=0.25\textwidth]{\ImgPath/rys/testy/shum/601_x2_EDSRMSEcrop.png}}
	\subfigure[CSNLN ($L_1$)]{\includegraphics[width=0.25\textwidth]{\ImgPath/rys/testy/shum/601_x2_CSNLNL1crop.png}}
	\subfigure[CSNLN ($L_1$)]{\includegraphics[width=0.25\textwidth]{\ImgPath/rys/testy/shum/601_x2_CSNLNMSEcrop.png}}
